...
status: Reading
author: '고장난기계'
source-url: 'https://www.novelupdates.com/series/im-the-only-one-with-a-different-genre/'
total-chapters: 227
current-chapter: 98
rating: 
...
![[covers/Im_the_Only_One_With_a_Different_Genre.webp|100|left]]

> [Read Here](https://www.novelupdates.com/series/im-the-only-one-with-a-different-genre/)

_NU: my chapter `c98`, latest `c227`_
